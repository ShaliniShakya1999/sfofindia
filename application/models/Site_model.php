...
class Site_model extends CI_Model {
	...
	public function defaults()
	{
		return array(
			...
			'bank_name' => 'AXIS BANK',
			'bank_account_name' => 'SHAHEED FOUNDATION',
			'bank_account_no' => '925010034361992',
			'bank_ifsc' => 'UTIB0001970',
			'bank_branch' => 'Sector 29, Gurgaon, Haryana 122001',
			'bank_upi_id' => 'shaheedfoundation@axisbank',
			'social_facebook' => '',
			'social_instagram' => '',
			'social_youtube' => 'https://youtube.com/@sfofindia',
			'social_linkedin' => '',
			'social_twitter' => '',
			...
			'whatsapp_template_donation' => 'donation_receipt',
			'whatsapp_template_welcome' => 'member_welcome',
			'pwa_enabled' => '0',
		);
	}
