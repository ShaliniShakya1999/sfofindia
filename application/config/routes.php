...
$route['member-forgot-password'] = 'admin/forgot_password';
$route['forgot-password/submit'] = 'admin/send_forgot_otp';
$route['verify-otp'] = 'admin/verify_forgot_otp';
$route['reset-password/submit'] = 'admin/do_reset_password';
