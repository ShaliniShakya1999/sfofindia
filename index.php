        ...
        <div class="owl-carousel header-carousel py-5">
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="carousel-text">
                            <h1 class="display-1 text-uppercase mb-3">Honoring Sacrifice. Supporting Families. Building Hope.</h1>
                            <p class="fs-5 mb-5">At Shaheed Foundation of India, we stand beside the families of our martyrs, offering respect, support, and long-term assistance to help them live with dignity and security.</p>
                            <div class="d-flex mt-4">
                                <a class="btn btn-primary py-3 px-4 me-3" href="donation.php">Support a Martyr’s Family</a>
                                <a class="btn btn-secondary py-3 px-4" href="contact.php">Join as a Volunteer</a>
                                <!-- <a class="btn btn-primary py-3 px-4 " href="#!">Support a Family</a> -->
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="carousel-img">
                            <img class="w-100" src="img/soldier1.avif" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="carousel-text">
                            <h1 class="display-1 text-uppercase mb-3">Standing Strong with the Families of Our Fallen Heroes</h1>
                            <p class="fs-5 mb-5">Shaheed Foundation of India is committed to honoring the brave souls who laid down their lives for the nation by ensuring care, dignity, and a secure future for their families.</p>
                            <div class="d-flex mt-4">
                                <a class="btn btn-primary py-3 px-4 me-3" href="donation.php">Support Disabled People</a>
                                <a class="btn btn-secondary py-3 px-4 me-3" href="contact.php">Become a Volunteer</a>
                                <!-- <a class="btn btn-primary py-3 px-4 " href="#!">Join Our Mission</a> -->
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="carousel-img">
                            <img style=" width: 700px; height: 400px;" src="img/army2.jpg" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="carousel-text">
                            <h1 class="display-1 text-uppercase mb-3">A Strong Support System for the Families of Our Martyrs</h1>
                            <p class="fs-5 mb-5">Shaheed Foundation of India is dedicated to honoring the supreme sacrifice of our brave martyrs by supporting their families with dignity, care, and long-term security.</p>
                            <div class="d-flex">
                                <a class="btn btn-primary py-3 px-4 me-3" href="donation.php">Donate Now</a>
                                <a class="btn btn-secondary py-3 px-4 me-3" href="contact.php">Join as a Volunteer</a>
                                <!-- <a class="btn btn-primary py-3 px-4" href="#!">Know More</a> -->
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="carousel-img">
                            <img class="w-80" src="img/Army.jpg" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.2s">
                    <div class="about-img">
                        <img class="img-fluid w-100" src="img/images.jpg" alt="Supporting Martyrs' Families">
                    </div>
                </div>
                    ...
                    <div class="row g-4 pt-2">
                        ...
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.5s">
                            <div class="h-100 bg-primary p-4 text-center rounded">
                                ...
                                <a class="btn btn-secondary py-2 px-4" href="donation.php">
                                    Donate Now
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-sm-6 col-md-6 wow fadeIn" data-wow-delay="0.1s">
                            <div class="service-item h-100">
                                ...
                                <a href="financial.php">Read More</a>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-6 wow fadeIn" data-wow-delay="0.5s">
                            <div class="service-item h-100">
                                ...
                                <a href="disability.php">Read More</a>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-6 wow fadeIn" data-wow-delay="0.7s">
                            <div class="service-item h-100">
                                ...
                                <a href="employment.php">Read More</a>
                            </div>
                        </div>
            ...
            <div class="row g-4 mt-4">
                    ...
                    <div class="donation-item d-flex h-100 p-4">
                        ...
                        <div class="donation-detail">
                            <div class="position-relative mb-4">
                                <img class="img-fluid w-100" src="img/army2.jpg" alt="Martyrs Family Support">
                            ...
                            <a href="donation.php" class="btn btn-primary w-100 py-3">
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.13s">
                    <div class="donation-item d-flex h-100 p-4">
                        ...
                        <div class="donation-detail">
                            <div class="position-relative mb-4">
                                <img class="img-fluid w-100" src="img/sf/15.jpeg" alt="Medical Support">
                                <a href="#!" class="btn btn-sm btn-secondary px-3 position-absolute top-0 end-0">
                                    Medical Care
                                </a>
                            </div>
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="donation-item d-flex h-100 p-4">
                        ...
                        <div class="donation-detail">
                            <div class="position-relative mb-4">
                                <img class="img-fluid w-100" src="img/education-child.webp" alt="Education Support">
                                <a href="#!" class="btn btn-sm btn-secondary px-3 position-absolute top-0 end-0">
                                    Education
                                </a>
                            </div>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="event-item h-100 p-4">
                        <img class="img-fluid w-100 mb-4" style="height: 225px;" src="img/sf/16.jpeg" alt="Health Care Support for Martyrs Families">
