    ...
    <div class="container">
        <div class="row g-5 py-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>SCO-88 Second Floor, Opp. Sector 12 A Gurgaon</p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+012 345 67890</p>
                <p class="mb-2"><i class="fa fa-envelope me-3"></i> info@sfofindia.com</p>
            ...
            <div class="col-lg-3 col-md-6">
                <h4 class="text-light mb-4"><a href="gallery.php">Gallery</a></h4>
                <div class="row g-2">

                    <div class="col-4"><a href="gallery.php">

                        <img class="gallery-img" src="img/sf/2.jpeg" alt="">
                    </a>
                    </div>
                    ...
                    <div class="col-4">
                        <a href="gallery.php">
                            ...
                            <img class="gallery-img" src="img/sf/19.jpeg" alt="">
                        </a>
                    </div>
                    ...
                    <div class="col-4">
                        <a href="gallery.php">
                            ...
                            <img class="gallery-img" src="img/sf/13.jpeg" alt="">
                        </a>
                    </div>
                    ...
                    <div class="col-4">
                        <a href="gallery.php">
                            ...
                            <img class="gallery-img" src="img/sf/7.jpeg" alt="">
                        </a>
                    </div>

                    <div class="col-4"><a href="gallery.php">

                        <img class="gallery-img" src="img/sf/15.jpeg" alt="">
                    </a>
                    </div>
                    ...
                    <div class="col-4">
                        <a href="gallery.php">
                            ...
                            <img class="gallery-img" src="img/sf/10.jpeg" alt="">
                        </a>
                    </div>
        ...
        <div class="copyright pt-5">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="fw-semi-bold" href="index.php">Shaheed Foundation India</a>, All Right Reserved.
                </div>
