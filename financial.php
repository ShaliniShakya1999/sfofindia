  ...
  <div class="container">
    ...
    <div class="text-center mx-auto wow fadeIn" data-wow-delay="0.1s" style="max-width:900px;">
      ...
      <div class="d-flex justify-content-center gap-3">
        <a href="donation.php" class="btn btn-primary px-4 py-2">Donate Now</a>
        <a href="contact.php" class="btn btn-outline-primary px-4 py-2">Join as Volunteer</a>
      </div>
    </div>
    ...
    <div class="row gy-5">
      ...
      <div class="col-lg-4">
        ...
        <div class="text-center">
          <a href="donation.php" class="btn btn-primary btn-lg w-100 py-3">
